...
const AboutHero = () => {
  ...
  return (
    <section ref={containerRef} className="relative min-h-screen bg-[#f8f7f5] dark:bg-black text-black dark:text-white overflow-hidden font-sans flex flex-col pt-24 pb-12">
      
      {/* Texture Overlay & Grid */}
      <div className="fixed inset-0 z-0 pointer-events-none opacity-[0.03] bg-[url('/noise.svg')]" />
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20 hidden dark:block" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(255,255,255,0.15) 1px, transparent 0)', backgroundSize: '32px 32px' }} />
      <div className="absolute inset-0 z-0 pointer-events-none opacity-20 block dark:hidden" style={{ backgroundImage: 'radial-gradient(circle at 2px 2px, rgba(0,0,0,0.1) 1px, transparent 0)', backgroundSize: '32px 32px' }} />
      ...
      <div className="relative z-10 flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 px-6 md:px-12 lg:px-20 lg:pl-28 w-full max-w-[1920px] mx-auto items-center">
        ...
        <div className="hidden lg:flex absolute left-8 top-1/2 -translate-y-1/2 flex-col items-center gap-4 about-reveal">
          ...
          <p className="text-[10px] font-bold tracking-[0.25em] text-zinc-500 uppercase rotate-180" style={{ writingMode: 'vertical-rl' }}>
            Available to work
          </p>
        </div>
        ...
        <div className="lg:col-span-5 flex flex-col justify-center order-2 lg:order-1 pt-12 lg:pt-0">
          ...
          <h1 className="about-reveal text-[18vw] sm:text-[14vw] lg:text-[8.5rem] leading-[0.85] font-black tracking-tighter mb-8 text-black dark:text-white">
            Shihab
            <br />
          ...
          <div className="about-reveal mb-12 ml-4">
            <p className={`${halimun.className} text-5xl text-red-600 transform -rotate-3 opacity-90`}>
              Shihab Saleem
            </p>
          </div>
        ...
        {/* Center: Portrait & Floating Cards */}
        <div className="lg:col-span-4 relative flex items-center justify-center order-1 lg:order-2 h-[50vh] lg:h-[80vh]">
          
          {/* Subtle Radial Glow in Center */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-md pointer-events-none z-0 bg-red-900/15 rounded-full blur-[80px]" />

          {/* Background Rings */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-[120%] pointer-events-none z-0 flex items-center justify-center">
            <div className="about-ring absolute w-[120%] aspect-square rounded-full border border-red-600/10" />
            <div className="about-ring absolute w-full aspect-square rounded-full border border-red-600/30 shadow-[0_0_80px_rgba(220,38,38,0.15)]" />
            <div className="about-ring absolute w-[75%] aspect-square rounded-full border border-red-600/20" />
          </div>

          {/* Portrait Image */}
          <div className="about-portrait-wrap relative w-full h-full max-w-sm lg:max-w-md z-10">
            <Image
              src={info.dpLight}
              alt={info.name}
              fill
              sizes="(max-width: 1024px) 100vw, 33vw"
              className="object-cover lg:object-contain object-bottom grayscale contrast-125 drop-shadow-[0_0_30px_rgba(220,38,38,0.2)] block dark:hidden"
              priority
            />
            <Image
              src={info.dpDark}
              ...
              fill
              sizes="(max-width: 1024px) 100vw, 33vw"
              className="object-cover lg:object-contain object-bottom grayscale contrast-125 drop-shadow-[0_0_30px_rgba(220,38,38,0.2)] hidden dark:block"
              priority
            />
          </div>
          ...
          <div className="about-float-card absolute -bottom-10 lg:bottom-10 left-0 lg:-left-24 z-20 px-8 py-6 bg-white/40 dark:bg-black/40 backdrop-blur-2xl border border-black/5 dark:border-white/5 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
            <p className="text-5xl font-black mb-1 text-black dark:text-white">30<span className="text-red-600">+</span></p>
          ...
          <div className="about-float-card absolute top-10 lg:top-20 right-0 lg:-right-24 z-20 px-8 py-6 bg-white/40 dark:bg-black/40 backdrop-blur-2xl border border-black/5 dark:border-white/5 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.05)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
            <p className="text-5xl font-black mb-1 text-black dark:text-white">3yr<span className="text-red-600">+</span></p>
